                ...
                <div class="row">
                    <div class="col-md card">
                        ...
                        <form action="<?=$destino?>" method="post">
                            ...
                            <div class="form-group">
                              <label>Celular</label>
                              <input value="<?php echo isset($dadosAlt) ? $dadosAlt['celular'] : '' ?>" name="celular" type="text" class="form-control celular" placeholder="Seu celular" required>
                            </div>

                            <div class="form-group">
                              <label>Endereço</label>
                              <input value="<?php echo isset($dadosAlt) ? $dadosAlt['endereco'] : '' ?>" name="endereco" type="text" class="form-control" placeholder="Seu endereço" required>
                            </div>

                            <div class="form-group">
                              <label>Número</label>
                              <input value="<?php echo isset($dadosAlt) ? $dadosAlt['numero'] : '' ?>" name="numero" type="text" class="form-control" placeholder="Seu número" required>
                            </div>

                            <div class="form-group">
                              <label>Bairro</label>
                              <input value="<?php echo isset($dadosAlt) ? $dadosAlt['bairro'] : '' ?>" name="bairro" type="text" class="form-control" placeholder="Seu Bairro" required>
                            </div>
                            ...
                            <div class="form-group">
                              <label>cargo</label>
                              <input value="<?php echo isset($dadosAlt) ? $dadosAlt['email'] : '' ?>" name="cargo" type="text" class="form-control" placeholder="Seu cargo" required>
                            </div>
